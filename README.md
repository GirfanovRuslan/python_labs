...
# 📚 Лаба 7: Тестирование (pytest + black)

**Суть:** Написание модульных тестов, измерение покрытия кода и поддержание единого стиля.

**Что делаем:**
- ✅ Тесты для функций из ЛР3 (`text.py`) и ЛР5 (`json_csv.py`)
- 📊 Измерение покрытия кода pytest-cov
- 🎨 Форматирование кода black
- 🧪 Позитивные и негативные тест-кейсы

**Техники:** `pytest`, `pytest-cov`, `black`, параметризация тестов.

*[📄 Полное описание заданий и скриншоты](./src/lab07/README.md)*

# 📚 Лаба 8:  ООП в Python — @dataclass, методы и сериализация

**Суть:** Изучение основ ООП в Python, использование декоратора `@dataclass` для описания моделей данных, реализация методов для работы с данными студентов, а также их сериализация и десериализация в формат JSON.


**Что делаем:**
- ✅ Реализация класса `Student` с полями: `fio`, `birthdate`, `group`, `gpa`.  
- 📊 Методы для работы с данными: `age()`, `to_dict()`, `from_dict()`, `__str__()`.  
- 🎨 Сериализация и десериализация объектов в формат JSON.  
- 🧪 Валидация данных (формат даты, диапазон GPA).

**Техники:** - Использование `@dataclass` для создания класса.  
- Сериализация и десериализация с помощью `json`.  
- Валидация данных. 

*[📄 Полное описание заданий и скриншоты](./src/lab08/README.md)*

# 📚 Лаба №9: База данных на CSV

**Суть:** Реализация простейшего хранилища данных студентов на основе CSV-файла с использованием CRUD-операций (Create, Read, Update, Delete) через класс Group.

**Что делаем:**
- ✅ Реализация класса `Group` для управления CSV-хранилищем студентов
- 🔄 CRUD-операции: `add()`, `list()`, `find()`, `update()`, `remove()`
- 📁 Работа с CSV-файлом как с базой данных
- 🔗 Интеграция с классом `Student` из ЛР8
- 🧪 Валидация данных и обработка ошибок

**Техники:**
- Использование модуля `csv` для работы с CSV-файлами
- Реализация паттерна CRUD для управления данными
- Работа с путями через `pathlib`
- Сериализация и десериализация объектов Student в CSV

*[📄 Полное описание заданий и скриншоты](./src/lab09/README.md)*
<div align="center">
